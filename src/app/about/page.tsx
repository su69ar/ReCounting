...
const team: { name: string; role: string; credential: string; image?: string }[] = [
  { name: "Rikotama", role: "Head Accountant & Advisor", credential: "Xero Certified Advisor. 8+ years of experience in accounting", image: "/team/GedeRikotama_ReCounting.png" },
