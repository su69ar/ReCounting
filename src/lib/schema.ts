...
export function generateServiceSchema(service: {
    ...
    return {
        ...
        url: service.url,
        image: service.image || `${siteConfig.url}/assets/logo/ReCounting_Accounting_Tax_Services_Bali.png`,
        provider: {
            "@id": `${siteConfig.url}#organization`,
        },
        areaServed: {
...
export function generateArticleSchema(article: {
    ...
    return {
        ...
        url: article.url,
        image: article.image || `${siteConfig.url}/assets/logo/ReCounting_Accounting_Tax_Services_Bali.png`,
