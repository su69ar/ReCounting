  ...
  return (
    <div ref={containerRef} className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <div 
        ...
        style={{
          background: "radial-gradient(circle, rgba(30, 77, 107, 0.22) 0%, transparent 70%)",
          filter: "blur(60px)",
        }}
        data-speed="0.5"
      />
      ...
      <div 
        ...
        style={{
          background: "radial-gradient(circle, rgba(198, 123, 92, 0.18) 0%, transparent 70%)",
          filter: "blur(60px)",
        }}
        data-speed="0.3"
      />
      ...
      <div 
        ...
        style={{
          background: "radial-gradient(circle, rgba(90, 138, 110, 0.15) 0%, transparent 70%)",
          filter: "blur(40px)",
        }}
        data-speed="0.8"
      />
